...
<qgis version="1.8.0-Trunk" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <uniquevalue>
    ...
    <symbol>
      ...
      <fillcolor red="53" blue="68" green="184"/>
      <fillpattern>SolidPattern</fillpattern>
      <texturepath>.</texturepath>
    </symbol>
    <symbol>
      <lowervalue>accepted</lowervalue>
      <uppervalue>accepted</uppervalue>
      <label></label>
      <pointsymbol>hard:circle</pointsymbol>
      <pointsize>2</pointsize>
      <pointsizeunits>pixels</pointsizeunits>
    ...
    <symbol>
      <lowervalue>flagged</lowervalue>
      <uppervalue>flagged</uppervalue>
      <label></label>
      <pointsymbol>hard:circle</pointsymbol>
      <pointsize>2</pointsize>
      <pointsizeunits>pixels</pointsizeunits>
    ...
    <symbol>
      ...
      <outlinestyle>SolidLine</outlinestyle>
      <outlinewidth>0.26</outlinewidth>
      <fillcolor red="0" blue="255" green="255"/>
      <fillpattern>Dense4Pattern</fillpattern>
      <texturepath>.</texturepath>
    </symbol>
  </uniquevalue>
  <customproperties/>
  <displayfield>spot_id</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    ...
    <edittype type="0" name="response"/>
    <edittype type="0" name="sensor"/>
    <edittype type="0" name="spot_id"/>
    <edittype type="0" name="status"/>
    <edittype type="0" name="year"/>
  </edittypes>
  <editform>.</editform>
